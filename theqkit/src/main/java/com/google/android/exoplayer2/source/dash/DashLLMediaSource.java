...
public final class DashLLMediaSource extends BaseMediaSource {

    static {
        ExoPlayerLibraryInfo.registerModule("goog.exo.dash");
    }

    /** Factory for {@link DashLLMediaSource}s. */
    public static final class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        /**
         * Creates a new factory for {@link DashLLMediaSource}s.
         *
        ...
        public Factory(DataSource.Factory dataSourceFactory) {
            this(new DefaultDashLLChunkSource.Factory(dataSourceFactory), dataSourceFactory);
        }
        ...
        /**
         * Returns a new {@link DashLLMediaSource} using the current parameters and the specified
         * sideloaded manifest.
         *
         * @param manifest The manifest. {@link DashManifest#dynamic} must be false.
         * @return The new {@link DashLLMediaSource}.
         * @throws IllegalArgumentException If {@link DashManifest#dynamic} is true.
         */
        public DashLLMediaSource createMediaSource(DashManifest manifest) {
            Assertions.checkArgument(!manifest.dynamic);
            isCreateCalled = true;
            if (streamKeys != null && !streamKeys.isEmpty()) {
                manifest = manifest.copy(streamKeys);
            }
            return new DashLLMediaSource(
                    manifest,
                    /* manifestUri= */ null,
         ...
         */
        @Deprecated
        public DashLLMediaSource createMediaSource(
                DashManifest manifest,
                @Nullable Handler eventHandler,
                @Nullable MediaSourceEventListener eventListener) {
            DashLLMediaSource mediaSource = createMediaSource(manifest);
        ...
        /**
         * Returns a new {@link DashLLMediaSource} using the current parameters.
         *
         * @param manifestUri The manifest {@link Uri}.
         * @return The new {@link DashLLMediaSource}.
         */
        @Override
        public DashLLMediaSource createMediaSource(Uri manifestUri) {
            isCreateCalled = true;
        ...
        public DashLLMediaSource createMediaSource(
                ...
                @Nullable Handler eventHandler,
                @Nullable MediaSourceEventListener eventListener) {
            DashLLMediaSource mediaSource = createMediaSource(manifestUri);
            if (eventHandler != null && eventListener != null) {
                mediaSource.addEventListener(eventHandler, eventListener);
            }
            return mediaSource;
    ...
    // *** ULL-CMAF Change ***
    // OLD:
    // public static final int DEFAULT_LIVE_PRESENTATION_DELAY_MS = 30000;
    // NEW
    ...
    // *** ULL-CMAF Change ***
    // OLD:
    // private static final int NOTIFY_MANIFEST_INTERVAL_MS = 30000;
    // NEW
    ...
    private static final String TAG = "DashLLMediaSource";
    ...
    public void prepareSourceInternal(@Nullable TransferListener mediaTransferListener) {
        ...
        if (sideloadedManifest) {
            ...
            loader = new Loader("Loader:DashLLMediaSource");
            handler = new Handler();
    ...
    private final class DefaultPlayerEmsgCallback implements PlayerEmsgCallback {
        ...
        public void onDashManifestRefreshRequested() {
            DashLLMediaSource.this.onDashManifestRefreshRequested();
        }

        @Override
        public void onDashManifestPublishTimeExpired(long expiredManifestPublishTimeUs) {
            DashLLMediaSource.this.onDashManifestPublishTimeExpired(expiredManifestPublishTimeUs);
        }
    }
    ...
    private final class ManifestCallback implements Loader.Callback<ParsingLoadable<DashManifest>> {
        ...
        public void onLoadCanceled(ParsingLoadable<DashManifest> loadable,
            ...
            DashLLMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
        }
